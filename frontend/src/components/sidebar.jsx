...
import { Users, MessageSquare, UserPlus, Users as UsersIcon } from "lucide-react";
...
const Sidebar = () => {
  ...
  return (
    <aside className="h-full w-20 lg:w-72 border-r border-[#e0e7ed] flex flex-col transition-all duration-200 bg-[#f8fafb]">
      <div className="border-b border-[#e0e7ed] w-full p-2 flex justify-around">
        <button
          onClick={() => setActiveTab("chats")}
          className={`p-2 rounded-lg ${activeTab === "chats" ? "bg-primary/10 text-primary" : "text-zinc-500"}`}
          title="Chats"
        >
        ...
        <button
          ...
          className={`p-2 rounded-lg ${activeTab === "friends" ? "bg-primary/10 text-primary" : "text-zinc-500"}`}
          title="Friends"
        >
          <UserPlus size={20} />
        </button>
        <button
          ...
          className={`p-2 rounded-lg ${activeTab === "groups" ? "bg-primary/10 text-primary" : "text-zinc-500"}`}
          title="Groups"
        >
          <UsersIcon size={20} />
        </button>
